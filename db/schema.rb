...
ActiveRecord::Schema.define(version: 20150814172205) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.integer  "run1_lineup_id",            limit: 2
    t.integer  "run1_origin_event_id",      limit: 2
    t.integer  "run2_fld_cd",               limit: 2
    t.integer  "run2_lineup_id",            limit: 2
    t.integer  "run2_origin_event_id",      limit: 2
    t.integer  "run3_fld_cd",               limit: 2
    t.integer  "run3_lineup_id",            limit: 2
    t.integer  "run3_origin_event_id",      limit: 2
    t.string   "run1_resp_catch_id",        limit: 8
    t.string   "run2_resp_catch_id",        limit: 8
    t.string   "run3_resp_catch_id",        limit: 8
    ...
    t.integer  "pa_hit_ball_ct",            limit: 2
    ...
    t.integer  "pa_bip_strike_ct",          limit: 2
